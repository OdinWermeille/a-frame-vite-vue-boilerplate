...
<template>
    <a-entity>
        ...
        <BaseCandleLight position="9.884 15.739 1.424" from="30" to="30"></BaseCandleLight>
        <a-gltf-model src="#lever-base" scale="0.5 0.5 0.5" rotation="0 -43.3 0" position="10.52 13.351 2.08"></a-gltf-model>
        <a-gltf-model src="#lever-arm" scale="0.5 0.5 0.5" rotation="-60 -43.3 0" position="10.6 13.79 2.08"></a-gltf-model>
    </a-entity>
    <a-entity
